...
const ActiveSlider = () => {
  ...
  return (
    ...
    <div className='absolute inset-x-0 bottom-0 h-12 bg-gradient-to-t from-teal-50 to-transparent'></div>

    <div className='flex items-center justify-center flex-col h-screen bg-teal-50'>
